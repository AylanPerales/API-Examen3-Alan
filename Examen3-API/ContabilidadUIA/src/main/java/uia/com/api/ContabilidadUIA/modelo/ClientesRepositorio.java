...
public class ClientesRepositorio {
		...
		{
			 contabilidad = new Gestor("C:\\Examen3-API\\Examen3-API\\ContabilidadUIA\\ListaProveedores.json");
			 //contabilidad = new Gestor("C:\\TSU-UIA\\2021-P\\REST\\ContabilidadUIA\\ListaProveedores.json");		
